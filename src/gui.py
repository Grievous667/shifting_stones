...
class Button():
    def __init__(self, pygame_surf, pos, name, func, img, hover_img=None, size=30, tc='white', bc=None, bgc=None) -> None:
...
class CardGUI():
    ...
    deck =  [
            ...
            [[[4, 9, 9], [9, 9, 9], [9, 9, 4]], 2] ,
            [[[1, 9, 9], [9, 2, 9], [9, 9, 2]], 5] ,
            [[[8, 8, 8], [7, 9, 6], [8, 8, 8]], [[7, 9, 6], [8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [7, 9, 6]], 2] ,
            [[[8, 4, 8], [8, 4, 8], [8, 4, 8]], [[4, 8, 8], [4, 8, 8], [4, 8, 8]], [[8, 8, 4], [8, 8, 4], [8, 8, 4]], 3] ,
            [[[8, 2, 8], [8, 7, 8], [8, 4, 8]], [[2, 8, 8], [7, 8, 8], [4, 8, 8]], [[8, 8, 2], [8, 8, 7], [8, 8, 4]], 3] ,
            [[[8, 8, 8], [5, 9, 5], [8, 8, 8]], [[5, 9, 5], [8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [5, 9, 5]], 2] ,
            [[[8, 8, 8], [9, 9, 0], [8, 8, 8]], [[9, 9, 0], [8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [9, 9, 0]], 2] ,
            [[[8, 9, 8], [8, 9, 8], [8, 1, 8]], [[9, 8, 8], [9, 8, 8], [1, 8, 8]], [[8, 8, 9], [8, 8, 9], [8, 8, 1]], 2] ,
            [[[8, 8, 8], [1, 9, 9], [8, 8, 8]], [[1, 9, 9], [8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [1, 9, 9]], 2] ,
            [[[8, 8, 8], [7, 2, 5], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [7, 2, 5]], [[7, 2, 5], [8, 8, 8], [8, 8, 8]], 3] ,
            [[[8, 8, 8], [7, 7, 7], [8, 8, 8]], [[7, 7, 7], [8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [7, 7, 7]], 3] ,
            [[[8, 8, 8], [4, 9, 4], [8, 8, 8]], [[4, 9, 4], [8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [4, 9, 4]], 2] ,
            [[[8, 8, 8], [6, 9, 7], [8, 8, 8]], [[6, 9, 7], [8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [6, 9, 7]], 2] ,
            [[[8, 8, 8], [9, 4, 3], [8, 8, 8]], [[9, 4, 3], [8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [9, 4, 3]], 2] ,
            [[[8, 8, 8], [6, 6, 6], [8, 8, 8]], [[6, 6, 6], [8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [6, 6, 6]], 3] ,
            [[[8, 5, 8], [8, 5, 8], [8, 5, 8]], [[5, 8, 8], [5, 8, 8], [5, 8, 8]], [[8, 8, 5], [8, 8, 5], [8, 8, 5]], 3] ,
            [[[8, 8, 8], [3, 9, 3], [8, 8, 8]], [[3, 9, 3], [8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [3, 9, 3]], 3] ,
            [[[8, 6, 8], [8, 9, 8], [8, 3, 8]], [[6, 8, 8], [9, 8, 8], [3, 8, 8]], [[8, 8, 6], [8, 8, 9], [8, 8, 3]], 2] ,
            [[[8, 2, 8], [8, 9, 8], [8, 2, 8]], [[2, 8, 8], [9, 8, 8], [2, 8, 8]], [[8, 8, 2], [8, 8, 9], [8, 8, 2]], 3] ,
            [[[8, 0, 8], [8, 9, 8], [8, 9, 8]], [[0, 8, 8], [9, 8, 8], [9, 8, 8]], [[8, 8, 0], [8, 8, 9], [8, 8, 9]], 2] ,
            [[[8, 8, 8], [4, 3, 6], [8, 8, 8]], [[4, 3, 6], [8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8],
[8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [5, 3, 8]], [[8, 8, 8], [8, 5, 3], [8, 8, 8]], [[8, 5, 3], [8, 8, 8], [8, 8, 8]], [[8, 8, 8], [8, 8, 8], [8, 5, 3]], 1] ,
                           ]
    ...
    def __init__(self, pygame_surf, coords=[50, 100]) -> None:
        ...
        for i in range(4): self.cards.append(Card(self.pygame_surf, self, CardGUI.deck[randint(0, len(CardGUI.deck)-1)], self.coords))
    ...
    def draw_two(self):
        self.cards.append(Card(self.pygame_surf, self, CardGUI.deck[randint(0, len(CardGUI.deck)-1)], self.coords))
        self.cards.append(Card(self.pygame_surf, self, CardGUI.deck[randint(0, len(CardGUI.deck)-1)], self.coords))

    def draw_up_to_four(self):
...
class Card():
    ...
    def __init__(self, pygame_surf, card_gui, target_card, coords, cso=-200) -> None:
        self.pygame_surf = pygame_surf
        self.padding = 2
        self.speed = 10
        ...
        self.point_val = target_card[len(target_card)-1]
        self.point_render = pygame.font.SysFont('Comic Sans MS', 40).render(str(self.point_val), True, "WHITE")
    ...
    def highlight_selection(self):
        pygame.draw.rect(self.pygame_surf, 'ORANGE', pygame.rect.Rect(self.current_coords[0], self.current_coords[1], self.card_img.get_width(), self.card_img.get_height()), 3)

    def highlight_discard_selection(self):
        pygame.draw.rect(self.pygame_surf, 'RED', pygame.rect.Rect(self.current_coords[0]+1, self.current_coords[1]+1, self.card_img.get_width()-2, self.card_img.get_height()-2), 3)

    def highlight_playable(self):
        pygame.draw.rect(self.pygame_surf, 'GREEN', pygame.rect.Rect(self.current_coords[0]-4, self.current_coords[1]-4, self.card_img.get_width()+8, self.card_img.get_height()+8), 5)
...
class infoGUI():
    def __init__(self, pygame_surf, card_gui, pos, sx, sy) -> None:
        ...
        self.card_gui = card_gui
        self.next_turn_b = Button(self.pygame_surf, [self.pos[0]+2 , self.pos[1]+4], "NextTurn", None, self.images[10], self.images[11], 35, 'white', None, None)
        self.show_hint_b = Button(self.pygame_surf, [self.pos[0]+37, self.pos[1]+4], "ShowHint", None, self.images[14], self.images[15], 35, 'white', None, None)
        
        self.buttons.append(self.next_turn_b)
        self.buttons.append(self.show_hint_b)
    ...
    def draw(self, point_sum):
        ...
        self.show_hint_b.draw()
        
        self.moves_txt = pygame.font.SysFont(['Consolas', 'Lucida Console', 'sans'], self.font_size).render('Cards Remaining: ' + str(self.num_cards), True, 'white')
        self.pygame_surf.blit(self.moves_txt, [self.pos[0] + screen_offset, self.pos[1] + self.padding])

        self.points_txt = pygame.font.SysFont(['Consolas', 'Lucida Console', 'sans'], self.font_size).render('Points: ' + str(self.points), True, 'white')
        self.pygame_surf.blit(self.points_txt, [self.pos[0] + (1*self.element_spacing) + self.moves_txt.get_width() + screen_offset, self.pos[1] + self.padding])
        ...
        self.pygame_surf.blit(self.avg_moves_txt, [self.pos[0] + (2*self.element_spacing) + self.moves_txt.get_width() + self.points_txt.get_width()  + screen_offset, self.pos[1] + self.padding])
        ...
        self.pygame_surf.blit(self.point_sum_txt, [self.pos[0] + (3*self.element_spacing) + self.moves_txt.get_width() + self.points_txt.get_width() + self.avg_moves_txt.get_width()  + screen_offset, self.pos[1] + self.padding])
